    ...
    def generate(self):
        while True:
            ...
            if random.randint(1, 2) == 1:
                px = random.randint(0, Const.ARENA_GRID_COUNT - 1) * Const.ITEM_BUFF_RADIUS * 2 + Const.ITEM_BUFF_RADIUS
                py = random.randint(0, Const.ARENA_GRID_COUNT - 1)* Const.ITEM_BUFF_RADIUS * 2 + Const.ITEM_BUFF_RADIUS
                generated_item = Item_Buff(self.model, Vector2(px, py), random.randint(1, 3))
            else:
                px = random.randint(0, Const.ARENA_GRID_COUNT - 1) * Const.ITEM_GUN_RADIUS * 2 + Const.ITEM_GUN_RADIUS
                py = random.randint(0, Const.ARENA_GRID_COUNT - 1) * Const.ITEM_GUN_RADIUS * 2 + Const.ITEM_GUN_RADIUS
